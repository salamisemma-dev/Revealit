...
class WebsiteContract(unittest.TestCase):
    ...
    def test_homepage_visual_adjustments_are_kept_in_sync(self):
        ...
        self.assertIn('background-position:22% center', html)
        self.assertIn('background-position:22% center', styles)
        self.assertIn('background-position:24% center', html)
        self.assertIn('background-position:24% center', styles)
        ...
        self.assertIn('background-position:22% center;opacity:.26', html)
        self.assertIn('background-position:22% center;opacity:.26', styles)
        self.assertIn('background-position:72% center', html)
        self.assertIn('background-position:72% center', styles)
        self.assertIn('background-position:64% center', html)
        self.assertIn('background-position:64% center', styles)
